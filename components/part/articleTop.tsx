                ...
                data.map((item:any,index:number)=>(
                    <div
                        ...
                        <div className="mb-5 w-2/5 h-full overflow-hidden">
                            ...
                            <img className="rounded-tl h-full rounded-bl object-cover" src={item.coverImage} alt={item.title} />
                            </Link>
                        ...
                        <div className="w-3/5 flex flex-col justify-center gap-2 py-4 px-4">
                            <span  className="mb-3 text-[#3b3f5c]  block text-[20px] font-medium tracking-tight text-gray-800 dark:text-white-light">
                                 <Link href={`/article/article-detail/${item.currentSlug}`}>
                                {item.title}
                                 </Link>
                            </span>
